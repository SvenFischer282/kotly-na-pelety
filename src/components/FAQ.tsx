  ...
  const faqs = [
    {
      ...
      answer: "Kotly na pelety ponúkajú až 50% úsporu nákladov na vykurovanie, sú ekologickejšie s minimálnymi emisiami CO2, automaticky sa regulujú a vyžadují minimálnu údržbu. Pelety sú obnoviteľný zdroj energie a ich cena je stabilnejšia ako pri fosílnych palivách."
    },
    {
      question: "Koľko stojí inštalácia kotla na pelety?",
      answer: "Cena kompletnej inštalácie kotla na pelety závisí od výkonu kotla, typu inštalácie a dodatočných komponentov. Celková investícia sa zvyčajne vráti za 5-7 rokov vďaka úsporám na prevádzkových nákladoch. Ponúkame aj dotácie a financovanie."
    },
    {
      question: "Ako často je potrebná údržba kotla na pelety?",
      answer: "Základná údržba zahŕňa vyprázdnenie popola raz týždenne počas vykurovacej sezóny a pravidelné čistenie výmenníka tepla. Profesionálny servis odporúčame raz ročne pred začiatkom vykurovacej sezóny. Moderné kotly majú samoočisťujúce systémy, čo minimalizuje potrebu údržby."
    },
    {
      question: "Aká je spotreba peliet a ich cena?",
      answer: "Priemerná spotreba je 1-2 kg peliet na hodinu v závislosti od výkonu kotla. Pre rodinný dom s rozlohou 150 m² potrebujete približne 3-5 ton peliet ročne. Cena peliet sa pohybuje okolo 250-300 EUR za tonu, čo je výrazne lacnejšie ako elektrické vykurovanie alebo zemný plyn."
    },
    {
      question: "Potrebujem povolenie na inštaláciu kotla na pelety?",
      answer: "Inštalácia kotla na pelety vyžaduje ohlásenie stavebným úradom a pravidelné kontroly komínom. Náš tím vám pomôže so všetkou potrebnou dokumentáciou a zabezpečíme kompletný servis vrátane kolaudácie a uvedenia do prevádzky."
    },
    {
      question: "Môžem kotol na pelety pripojiť k existujúcemu vykurovaciemu systému?",
      answer: "Áno, kotly na pelety možno pripojiť k existujúcim radiátorovým alebo podlahovým vykurovacím systémom. Môžu fungovať aj v kombinácii s iným zdrojom tepla (hybridný systém) alebo s bojlerom na prípravu teplej úžitkovej vody."
    },
    {
      question: "Aká je životnosť kotla na pelety?",
      answer: "Pri správnej údržbe má kvalitný kotol na pelety životnosť 15-20 rokov. Moderne kotly sú vyrobené z vysoko kvalitných materiálov odolných voči korózii a vysokým teplotám. Všetky naše kotly sú certifikované a majú záručnú a pozáručnú podporu."
    }
  ];
